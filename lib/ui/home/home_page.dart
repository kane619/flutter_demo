    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
         child: Column(
           ...
           children: [
             Container(
               // decoration: BoxDecoration(image: DecorationImage(image: NetworkImage('https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=314202116,1401007204&fm=26&gp=0.jpg'), fit: BoxFit.cover)),
               child: Column(
                 children: [
                   Padding(
                     ...
                     child: Row(
                       children: [
                         IconText("苏州", textAlign: TextAlign.center, icon: Icon(Icons.location_on, color: AppColors.color_434343,), iconSize: Screen.sp(55), style: TextStyle(fontSize: Screen.sp(46), color: AppColors.color_434343,)),
                         ...
                         return GestureDetector(
                           child: Container(
                             decoration: BoxDecoration(borderRadius: BorderRadius.circular(10), image: DecorationImage(
                               ...
                               image: NetworkImage('https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=314202116,1401007204&fm=26&gp=0.jpg'),
                                 fit: BoxFit.cover
                             )),
                           ),
                           onTap: () {
